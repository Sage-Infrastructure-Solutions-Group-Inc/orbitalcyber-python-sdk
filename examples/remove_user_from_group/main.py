...
parser = ArgumentParser(description='basic example of how to remove a user to a group using the OrbitalCyber API.')
...
add_members_resp = client.delete(f"/api/auth/company-mgmt/group/{args.group_id}/members/remove/{args.user_id}")
